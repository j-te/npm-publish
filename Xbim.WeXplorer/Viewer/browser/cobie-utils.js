...
var CobieUtils = /** @class */ (function () {
    function CobieUtils(lang, culture) {
        this.settings = {
            decimalPlaces: 4
        };
        this._dictionary = new attribute_dictionary_1.AttributeDictionary(lang, culture);
    }
    CobieUtils.prototype.getVisualEntity = function (entity, type) {
        if (!entity || !type)
    ...
    CobieUtils.prototype.getVisualModel = function (data) {
        if (!data)
    ...
    CobieUtils.prototype.getContacts = function (data) {
        if (!data)
            throw 'data must be defined';
        var result = [];
    ...
    CobieUtils.prototype.getSpatialStructure = function (data, types) {
        if (!data)
            throw 'data must be defined';
    ...
    CobieUtils.prototype.getZones = function (data, facility) {
        if (!data)
            throw 'data must be defined';
        var result = [];
    ...
    CobieUtils.prototype.getSystems = function (data, types) {
        if (!data)
            throw 'data must be defined';
        var result = [];
    ...
    CobieUtils.prototype.getAssetTypes = function (data) {
        if (!data)
            throw 'data must be defined';
        var result = [];
    ...
    CobieUtils.prototype.getProperties = function (entity) {
        if (!entity)
            throw 'entity must be defined';
        var tr = this.getTranslator();
        var result = [];
    ...
    CobieUtils.prototype.getAttributes = function (entity) {
        if (!entity)
            throw 'entity must be defined';
        var result = [];
        var attributes = null;
    ...
    CobieUtils.prototype.getAssignments = function (entity, type) {
        if (!entity || !type)
        ...
        for (var attr in entity) {
            ...
            var collection = new visual_assignment_set_1.xVisualAssignmentSet();
    ...
    CobieUtils.prototype.getDocuments = function (entity, type) {
        if (!entity || !type)
            throw 'entity and type must be defined';
        var result = [];
        for (var attr in entity) {
    ...
    CobieUtils.prototype.getIssues = function (entity) {
        if (!entity)
            throw 'entity and type must be defined';
        var result = [];
        for (var attr in entity) {
    ...
    CobieUtils.prototype.setLanguage = function (lang, culture) {
        this._dictionary = new attribute_dictionary_1.AttributeDictionary(lang, culture);
    };
    CobieUtils.prototype.getValueString = function (value) {
    ...
    CobieUtils.prototype.getTranslator = function () {
        var self = this;
...
exports.CobieUtils = CobieUtils;
//# sourceMappingURL=cobie-utils.js.map